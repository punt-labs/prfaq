...
\prfaqversion{0}{0}  % v0.0 — template placeholder; generation sets v1.0
...
which leads to NEGATIVE OUTCOME. Despite EXISTING SOLUTIONS, customers
still face UNRESOLVED PAIN because REASON.
