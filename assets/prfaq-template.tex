...
\riskmatrix
  {VALUE RISK ASSESSMENT — Will customers buy/choose this?}
  {USABILITY RISK ASSESSMENT — Can customers figure out how to use it?}
  {FEASIBILITY RISK ASSESSMENT — Can we build it with available resources?}
  {VIABILITY RISK ASSESSMENT — Does it work for the business?}
