...
\riskitem{Value --- \textcolor{RiskAmber}{RATING}}{VALUE RISK ASSESSMENT — Will customers buy/choose this?}

\riskitem{Usability --- \textcolor{RiskGreen}{RATING}}{USABILITY RISK ASSESSMENT — Can customers figure out how to use it?}

\riskitem{Feasibility --- \textcolor{RiskGreen}{RATING}}{FEASIBILITY RISK ASSESSMENT — Can we build it with available resources?}

\riskitem{Viability --- \textcolor{RiskGreen}{RATING}}{VIABILITY RISK ASSESSMENT — Does it work for the business?}
\end{mdframed}
