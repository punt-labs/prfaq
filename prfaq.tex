...
The consequences are visible at both ends of the market. Analysts at HFS Research estimate the Global 2000 carry \$1.5--2 trillion in accumulated technical debt~\cite{hfs2025techdebt}. At the startup end, AI-generated code introduces its own quality burden: 66\% of developers cite ``almost-right'' AI output as their top frustration, and 45\% report that debugging AI-generated code takes longer than expected~\cite{stackoverflow2025survey}. Many products built during the current ``vibe coding'' wave~\cite{karpathy2025vibecoding} already face significant rebuilds --- not because the code is bad, but because the code solves the wrong problem with confidence.
