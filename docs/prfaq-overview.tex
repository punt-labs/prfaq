...
The quality gate is compilation of every LaTeX file in the repo's compile
directories (\texttt{.}, \texttt{plugin/assets}, \texttt{docs}), which the
\texttt{Makefile} globs rather than lists, so a new document is gated the moment
it exists. Today that is five files:
